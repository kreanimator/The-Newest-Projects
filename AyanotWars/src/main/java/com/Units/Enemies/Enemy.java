...
public class Enemy extends Unit {
    ...
    public void chaseEnemies(int[][] obstacles) throws ArithmeticException {
        if (enemyList == null){
    ...
    public void attackEnemies() {
        ...
        for(Enemy enemy: enemyList) {
            if (facingDirection == FORWARD && this.pos.x == enemy.getPos().x && this.pos.y == enemy.getPos().y + 1) {

                enemy.getDamage(5);
                System.out.println("Enemy was hitted front");
                getCurrentHP();
            }
            if (facingDirection == RIGHT && this.pos.x == enemy.getPos().x - 1 && this.pos.y == enemy.getPos().y) {

                enemy.getDamage(5);
                System.out.println("Enemy was hitted right");
                getCurrentHP();
            }
            if (facingDirection == BACKWARD && this.pos.x == enemy.getPos().x && this.pos.y == enemy.getPos().y - 1) {

                enemy.getDamage(5);
                System.out.println("Enemy was hitted backw");
                getCurrentHP();
            }
            if (facingDirection == LEFT && this.pos.x == enemy.getPos().x + 1 && this.pos.y == enemy.getPos().y) {
